...
**Nature de ce document : étude, pas une architecture adoptée.** Aucune décision d'implémentation n'est prise ici. Voir la section 7 pour la marche à suivre proposée (non réalisée) et la section 6 pour les questions qui restent ouvertes.
