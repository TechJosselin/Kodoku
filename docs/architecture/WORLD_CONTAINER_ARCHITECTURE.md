...
- **World Containers V1 complet — toujours non terminé.** Manquent : interaction monde de production (`Component.IPressable`), prefab `Wooden_Crate`, UI de production, décisions de persistance, transfert partiel/stacking. Voir [../status/ROADMAP.md](../status/ROADMAP.md) pour l'ordre recommandé de la suite.
