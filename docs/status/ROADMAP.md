...
4. Stacks, split/merge et quantités (étape 8) — **audit de conception terminé** (jalon 0), voir [../architecture/INVENTORY_STACK_ARCHITECTURE.md](../architecture/INVENTORY_STACK_ARCHITECTURE.md) pour la politique d'identité, l'architecture du cœur, la sémantique de chaque opération, la stratégie de concurrence et la roadmap détaillée (jalons 1 à 5) ; aucune implémentation encore commencée.
