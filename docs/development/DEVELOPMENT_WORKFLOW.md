...
6. **Compiler** — via l'éditeur s&box (hotload) ou Claude Bridge en lecture (`get_compile_errors`) ; voir [../../.claude/rules/sbox-bridge.md](../../.claude/rules/sbox-bridge.md).
...
8. **Vérifier les logs** (`read_log`, `get_compile_errors`) pour toute erreur ou avertissement silencieux.
